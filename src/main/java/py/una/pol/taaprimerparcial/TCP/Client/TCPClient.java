...
import java.io.*;
import java.net.*;
import static py.una.pol.taaprimerparcial.TCP.Client.Menu.MenuCLI;
import static py.una.pol.taaprimerparcial.TCP.Client.Menu.menuError;
import static py.una.pol.taaprimerparcial.TCP.Client.Menu.menuRespuesta;
